...
(function () {
    ...
    var loadPackage = function (metadata) {
        ...
        var PACKAGE_NAME = './wm/uncrustify.data';
        var REMOTE_PACKAGE_BASE = './wm/uncrustify.data';
        ...
        function runWithFS() {
            ...
            function processPackageData(arrayBuffer) {
                ...
                Module['removeRunDependency']('datafile_uncrustify.data');

            };
            Module['addRunDependency']('datafile_uncrustify.data');
    ...
    loadPackage({"files": [{"filename": "/config.cfg", "start": 0, "end": 18642}], "remote_package_size": 18642});
...
var wasmBinaryFile;
wasmBinaryFile = '/wm/uncrustify.wasm';
